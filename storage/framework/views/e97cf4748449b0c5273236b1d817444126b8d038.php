        ...
        <section class="section-about" id="about">
            ...
            <div class="row">
                ...
                <div class="col-1-of-2">
                    ...
                    <a href="<?php echo e(asset('icons/BrianResume.pdf')); ?>" class="btn-text slowmo">Learn more
                        &rarr;</a>
                </div>
                <div class="col-1-of-2">
                    ...
                    <div class="box">
                        <div class="imgbox">
                            ...
                            <div class="content">
                                ...
                                <button class="btn2-imgbtn" onclick="popupF(<?php echo e($project->imgURL,$project->description,$project->title); ?>)">More
                                    info</button>
